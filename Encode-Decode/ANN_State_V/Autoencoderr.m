classdef(Sealed, InferiorClasses = {?network}) Autoencoderr
    ...
    methods(Hidden)
        function autoenc = Autoencoderr(net, useGPU, visualizationDimensions, trainedOnImages)
            autoenc.Network = net;
...
defaultTrainingAlgorithm = 'trainscg2';
validTrainingAlgorithms = {'traingdm', 'traingda', 'traingdx', 'trainlm', 'trainrp', 'traincgf', 'traincgb', 'trainbfg', 'traincgp', 'trainoss','trainscg2'};
        ...
        function autoenc = train(X, net, useGPU)
            ...
            autoenc = Autoencoderr(net, useGPU, visualizationDimensions, trainedOnImages);
        end
